<template>
  <div id="app">
    ...
    >
      ...
      <button class="ml-3" v-on:click="isFaded = !isFaded" type="button">
        Test Fade
      </button>
      <button class="ml-3" v-on:click="isBounced = !isBounced" type="button">
        Test Bounce
      </button>
      <button class="ml-3" v-on:click="isRolled = !isRolled" type="button">
        Test Rolling
      </button>
      <button
        class="ml-3"
